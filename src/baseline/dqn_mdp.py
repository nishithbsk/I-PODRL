...
model_1.add(Activation('relu'))
model_1.add(Convolution2D(64, 3, 3, subsample=(1, 1)))
model_1.add(Activation('relu'))
model_1.add(Flatten())
model_1.add(Dense(512))
model_1.add(Activation('relu'))
model_1.add(Dense(nb_actions))
...
dqn = DQNAgent(model=model_1, nb_actions=nb_actions, policy=policy, memory=memory,
               processor=processor, nb_steps_warmup=50000, gamma=.99, delta_range=(-1., 1.), target_model_update=10000, train_interval=4)
